    ...
    public class ReMenuLabel : UiElement
	{
		...
		private static GameObject ButtonPrefab
		{
			get
            {
                ...
                {
                    _buttonPrefab = MenuEx.QMInstance.transform.Find("CanvasGroup/Container/Window/QMParent/Menu_Settings/Panel_QM_ScrollRect/Viewport/VerticalLayoutGroup/Buttons_Debug_Row_1/Button_FPS").gameObject;
                }
