...
namespace ReMod.Core.UI.ActionMenu
{
    public static class ActionMenuAPI
    {
        ...
        public static global::ActionMenu activeActionMenu { get; private set; }
        public static bool IsOpen(this ActionMenuOpener actionMenuOpener) => actionMenuOpener.field_Private_Boolean_0;
        public static bool IsWeelOpen => ActionMenuOpener1.field_Private_Boolean_0 || ActionMenuOpener2.field_Private_Boolean_0;
        ...
        {
            if (!ActionMenuOpener1.IsOpen() && ActionMenuOpener2.IsOpen()) return ActionMenuOpener2;
